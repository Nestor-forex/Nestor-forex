...
export default {
  ...
  splash: {
    lema: 'Scan quotidien du marché, journal des opérations et gestion du risque.',
    entrar: 'Entrer',
    iniciaSesion: 'Accède à ton compte',
  },
  ...
  barrido: {
    titulo: 'Scan du jour',
    tituloLargo: 'Scan quotidien · Forex',
    ...
    descargandoLargo: 'Téléchargement de 7 mois de prix quotidiens…',
    pie: 'Vraies bougies journalières (haut, bas et clôture). Analyse éducative, pas un conseil financier.',
  ...
  detalle: {
    ...
    pip2: '1 pip = 0.01',
    pip4: '1 pip = 0.0001',
    granularidad: 'une bougie par jour',
    ...
    escenarioTexto: ({ fuerte, debil, direccion, accion, precio, tp, ema }) =>
      `${fuerte} est la devise forte du scan et ${debil} est à la traîne, la paire est en tendance ${direccion}. ${accion} ${precio}, avec un objectif à ${tp}. Meilleure entrée sur un repli vers l'EMA20 (${ema}).`,
    alcista: 'haussière',
    bajista: 'baissière',
  ...
  importar: {
    aviso: {
      ...
      otrasTablas: ({ n }) => `${n} ${n === 1 ? 'ligne située' : 'lignes situées'} dans d’autres tableaux du rapport (ordres et transactions) ont été écartées : c’est la même opération comptée autrement.`,
  ...
  clima: {
    sol: "Dégagé",
    solNubes: "Soleil et nuages",
    nublado: "Nuageux",
    niebla: "Brouillard",
    tormenta: "Orage",
    solAyuda: "Tendance nette avec de la force derrière, pas encore étirée.",
    solNubesAyuda: "Il y a une tendance, mais la force est faible ou le mouvement est déjà fait.",
    nubladoAyuda: "Pas de direction claire : le prix va et vient.",
    nieblaAyuda: "Latéral et sans force : on ne voit rien, mieux vaut ne pas deviner.",
    tormentaAyuda: "Amplitude très large : ton stop sera mis à l’épreuve quoi que tu fasses.",
  },
  ...
  calc_barrido: {
    ...
    entrada: ({ precio, ema }) => `${precio} actuel · mieux sur un repli vers EMA20 (${ema})`,
    slCompra: ' (sous le plus bas de 10 jours − ½ ATR)',
    slVenta: ' (au-dessus du plus haut de 10 jours + ½ ATR)',
    rbBajo: ' ⚠ en dessous de 1:1.5',
    invalCompra: ({ sl, b }) => `clôture quotidienne sous ${sl}, ou perte de force de ${b} au classement.`,
    invalVenta: ({ sl, q }) => `clôture quotidienne au-dessus de ${sl}, ou retour en force de ${q}.`,
    corte: ({ fecha }) => `Données à la clôture du ${fecha} · bougies journalières`,
  ...
  historial: {
    ...
    vacioLargo: 'La vigie examine le marché une fois par jour et note ici ce qu’elle trouve. Dès que le premier signal apparaîtra, tu le verras.',
