...
// proyecto de Firebase, así que el vigía de swing no debe escribirle a los
// aparatos suscritos a la app de intradía.
export const APP = 'swing'
...
export async function enviarAvisos(nuevas, entorno = process.env, bdInyectada = null) {
  ...
  // fallo silencioso. Ver el comentario de AVISOS_PAUSADOS arriba.
  //
  ...
  if (AVISOS_PAUSADOS && entorno.PUSH_SIN_PAUSA !== '1') {
    return { estado: 'en-pausa', candidatas: nuevas.length, motivo: 'reglas en revisión tras el banco de pruebas' }
  }
